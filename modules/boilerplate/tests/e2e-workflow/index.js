 ...
 *
 * @module modules/boilerplate/tests/e2e-workflow/index
 */
      ...
      steps: {
        ...
        'Formular-Elemente': {
          ...
          elements: {
            ...
            '//*[contains(@class, "fieldcontainer_selectinput")]': 'Auswahlliste\n- bitte wählen -\ndies\ndas\nvielleicht ein Pflichtfeld',
          ...
          input: {
            '//input[@name="textinput"]': 'Text input',
            ...
            '//textarea[@name="textareainput"]': 'and now for something completely different',
            '//input[@name="grouptextinput1"]': '12345',
            '//input[@name="grouptextinput2"]': 'part two of input text group',
        ...
        'Formular-Eingaben': {
          ...
          elements: {
            ...
            '//input[@type="text"][@name="grouptextinput2"][@value="part two of input text group"]': '',
